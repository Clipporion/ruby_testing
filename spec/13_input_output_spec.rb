...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    subject(:new_game) { described_class.new(7, '5') }
  ...
  describe '#verify_input' do
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        check_input = '10'
        verified_input = game_check.verify_input(check_input)
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      subject(:game) { described_class.new(6, '6', 8) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        congrats_phrase = "That was hard. It took you 8 guesses!\n"
        expect { game.final_message }.to output(congrats_phrase).to_stdout
      end
    end
  end
